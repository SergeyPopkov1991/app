                       ...
                       <div class="row">
                           ...
                           <div class="col-12">
                               <div class="form-group">
                                   <textarea class="form-control w-100" name="message" id="message" cols="30" rows="9" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Текст записис'" placeholder="Текст записи"></textarea>
                               </div>
                           </div>
                           <div class="col-sm-6">
                               <div class="form-group">
